            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show plain notification with payload---显示带有负载的普通通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show plain notification that has no body with payload --显示没有正文的有效负载的简单通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show plain notification with payload and update channel description [Android]---显示带有有效负载的简单通知并更新频道说明[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show plain notification as public on every lockscreen [Android]-在每个锁定屏幕上将公开通知显示为公开[Android]',
                    onPressed: () async {
                      await _showPublicNotification();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Cancel notification-取消通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Schedule notification to appear in 5 seconds, custom sound, red colour, large icon, red LED-安排在5秒钟内显示通知，自定义声音，红色，大图标，红色LED',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText: 'Repeat notification every minute--每分钟重复一次通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Repeat notification every day at approximately 10:00:00 am--每天大约上午10:00:00重复通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Repeat notification weekly on Monday at approximately 10:00:00 am--每周星期一大约10:00:00重复发送通知',
                    onPressed: () async {
                      await _showWeeklyAtDayAndTime();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Show notification with no sound---显示无声音的通知',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show notification that times out after 3 seconds [Android]---显示3秒钟后超时的通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show big picture notification [Android]---显示大图通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show big picture notification, hide large icon on expand [Android]--显示大图通知，在展开时隐藏大图标[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show media notification [Android]--显示媒体通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show big text notification [Android]--显示大文字通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show inbox notification [Android]-显示收件箱通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show messaging notification [Android]--显示消息通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show grouped notifications [Android]-显示分组的通知[Android]  ',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show ongoing notification [Android]-显示正在进行的通知[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show notification with no badge, alert only once [Android]--显示不带徽章的通知，仅提醒一次[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show progress notification - updates every second [Android]-显示进度通知-每秒更新一次[Android]',
                    onPressed: () async {
                  ...
                  PaddedRaisedButton(
                    buttonText:
                        'Show indeterminate progress notification [Android]--显示不确定的进度通知[Android]',
                    onPressed: () async {
                      await _showIndeterminateProgressNotification();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Check pending notifications--查看待处理的通知',
                    onPressed: () async {
                      await _checkPendingNotificationRequests();
                    },
                  ),
                  PaddedRaisedButton(
                    buttonText: 'Cancel all notifications--取消所有通知',
                    onPressed: () async {
